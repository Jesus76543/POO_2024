...
def main():
    ...
    while True:
        ...
        if opcion == "1":
            ...
            pg.agregar_peliculas(peliculas, nombre_pelicula, genero_pelicula, anio_lanzamiento)
        elif opcion == "2":
            ...
            pg.actualizar_pelicula(peliculas, nombre_pelicula, genero_pelicula, anio_lanzamiento)
        elif opcion == "5":
            nombre_pelicula = input("Ingresa el nombre de la película a buscar: ")
            pg.buscar_pelicula(peliculas, nombre_pelicula)
        elif opcion == "6":
            pg.vaciar_lista(peliculas)
        elif opcion == "7":
            print("¡Hasta luego!")
            break
        else:
